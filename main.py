...
print("The Shieldhoddlers of Grojec live there since ages and explore the unknown forests of the mystic mountain")
...
class Player(Character):
  ...
  def explore(self):
    if self.state != 'normal':
      ...
      print("%s explores the woods." % self.name)
      if randint(0, 1):
        self.enemy = Enemy(self)
...
# ACTUAL GAME STARTS HERE NOT THE CLEANEST CODE EVER 

p = Player()
p.name = input("What is your shieldholder's name? ")
print("(type help to get a list of actions)\n")
print("%s enters a mystical forest, searching for adventure." % p.name)
